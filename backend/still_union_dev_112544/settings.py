"""
Django settings for still_union_dev_112544 project.
...
ROOT_URLCONF = 'still_union_dev_112544.urls'
...
WSGI_APPLICATION = 'still_union_dev_112544.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "still_union_dev_112544 API",
    "DESCRIPTION": "API documentation for still_union_dev_112544 App",
    "VERSION": "v1",
}
