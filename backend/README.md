...
## Project Structure
    ...
    ├── still_union_dev_112544  # Django project configurations
...
1. Clone this repo and `cd still_union_dev_112544`
...
2. Clone this repo and `cd still_union_dev_112544`
